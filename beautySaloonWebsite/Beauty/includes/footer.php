...
<span class="text" ><?php  echo $row['PageDescription'];?></span></li>
	                <li><a href="#">
<span class="icon icon-phone"></span><span class="text">+<?php  echo $row['MobileNumber'];?></span></a></li>
        ...
        <div class="row">
          <div class="col-md-12 text-center">
            ...
            <p>
  &copy; 2023 Kenan Beauty Salon. </p>
          </div>
        </div>
      </div>
    </footer>